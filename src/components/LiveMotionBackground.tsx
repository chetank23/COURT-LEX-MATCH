...
const ORBS: OrbSpec[] = [
  {
    className:
      "absolute -top-28 right-[6%] h-[36rem] w-[36rem] rounded-full bg-primary/11 blur-[125px]",
    duration: 26,
    x: [0, -50, 30, 0],
    y: [0, 40, -25, 0],
    scale: [1, 1.08, 0.94, 1],
  ...
  {
    className:
      "absolute -bottom-24 left-[2%] h-[30rem] w-[30rem] rounded-full bg-accent/12 blur-[115px]",
    duration: 22,
    x: [0, 38, -26, 0],
    y: [0, -30, 34, 0],
    scale: [1, 0.9, 1.05, 1],
  ...
  {
    className:
      "absolute top-[20%] left-[28%] h-[22rem] w-[22rem] rounded-full bg-primary/8 blur-[95px]",
    duration: 18,
    x: [0, 24, -20, 0],
    y: [0, -22, 18, 0],
    scale: [1, 1.06, 0.96, 1],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M206 126 C224 170 276 170 294 126 Z"
            fill="currentColor"
            fillOpacity="0.18"
            stroke="currentColor"
            strokeWidth="2"
        ...
        >
          <path
            d="M306 126 C324 170 376 170 394 126 Z"
            fill="currentColor"
            fillOpacity="0.18"
            stroke="currentColor"
            strokeWidth="2"
